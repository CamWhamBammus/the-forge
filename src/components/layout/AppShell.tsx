...
import { Award, Flame, Monitor } from "lucide-react";
      ...
      */}
      <aside className="flex w-56 shrink-0 flex-col border-r border-[#7a5738]/12 bg-[#10190f] text-[#f6efe1]">
        <div className="flex items-center gap-2 px-5 py-6">
          <Flame size={20} className="text-[#cf9c52]" strokeWidth={1.75} />
          <span className="font-serif text-[1.05rem] tracking-tight">The Forge</span>
        </div>
